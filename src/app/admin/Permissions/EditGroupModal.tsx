...
interface EditGroupModalProps {
  group: Group;
  onClose: () => void;
  onSave: (groupId: string, groupData: Partial<Group>) => void;
  onDelete: (groupId: string) => void;
  availablePermissions: Record<string, { id: string; name: string; }[]>;
}

export default function EditGroupModal({ group, onClose, onSave, availablePermissions }: EditGroupModalProps) {
