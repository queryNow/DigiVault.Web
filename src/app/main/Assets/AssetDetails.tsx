      ...
      <div className="flex justify-between items-start py-5 border-b border-gray-200">
        <div>
          <div className="flex items-center">
            ...
            <span className={`ml-4 px-2.5 py-0.5 rounded-full text-xs font-medium ${asset.status === 'published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
              }`}>
              {asset.status}
            </span>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-2">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${asset.riskLevel === 'High' ? 'bg-red-100 text-red-800' :
                ...
                {asset.signatures.required.map((signer) => {
                  ...
                  return (
                    <div key={signer} className="flex items-center justify-between py-2 border-b border-gray-200">
                      <div className="flex items-center">
                        <div className={`h-8 w-8 rounded-full flex items-center justify-center ${isCompleted ? 'bg-green-100' : 'bg-gray-100'
                          }`}>
                          {isCompleted ? (
              ...
              {assetDocuments.map((doc) => (
                <div key={doc.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex-1">
                    ...
                    <div className="mt-1">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${doc.metadata.confidentiality === 'High' ? 'bg-red-100 text-red-800' :
